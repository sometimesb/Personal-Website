    ...
    <div>
      <nav>
        ...
        <ul className="mainbar">
          ...
          <li><a href="./resume/BilalZakariaResume_2024.docx" download>Resume</a></li>
        ...
        <ul className="sidebar">
          ...
          <li onClick={hideSideBar}><a href="./resume/BilalZakariaResume_2024.docx" download>Resume</a></li>
